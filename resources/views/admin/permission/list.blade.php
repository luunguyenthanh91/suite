                            ...
                            <table id="simple-table" class="table table-striped table-bordered table-hover">
                                ...
                                <tbody>
                                    <tr v-for="item in list">
                                        ...
                                        <td>
                                            <p v-if="item.edit == 1" >((item.group.name))</p>
                                            <select  v-if="item.edit == 2" class="form-control col-xs-12 col-sm-12" v-model="item.group_permission_id" >
                ...
                <div class="modal-container" v-if="addModal == 2">
                    <div class="container-popup  col-xs-4">
                        <div class="breadcrumbs">
                            <h3>
                                <span class="hidden-320 ng-binding">Thêm Phân Quyền</span>
                            </h3>
                        ...
                        <div class="form-horizontal col-xs-12 mt-10">
                            <div class="form-group">
                                <label class="col-sm-2 control-label no-padding-right" > Tên Quyền </label>
                                <div class="col-sm-10">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" placeholder="Tên Nhóm" v-model="guardAddData" class="col-xs-12 col-sm-12">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label no-padding-right" > Nhóm </label>
                                <div class="col-sm-10">
                                    <select  class="form-control col-xs-12 col-sm-12" v-model="groupAddData" >
                                        <option value="">Chọn Nhóm</option>
                                        <option v-for="group in groups" v-bind:value="group.id">((group.name))</option>
                                    </select>
                                </div>
    ...
    methods: {
        ...
        deleteRecore(_i) {
            ...
            Swal.fire({
                ...
                that.loadingTable = 1;
                $.ajax({
                    url: "/admin/permission/delete/"+_i.id,
                    type: 'GET',
                    dataType: 'json',
        ...
        onLoadPagination() {
            ...
            $.ajax({
                type: 'GET',
                url: "{{route('admin.getPermissions')}}?page=" + this.page + "&name=" + this.conditionName,
                success: function(data){
                    if (data.count > 0) {
                        data.data.map(item => {
                            item.edit = 1;
