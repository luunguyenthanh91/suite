...
<div class="main-content-inner" id="list-data">
    ...
    <div class="page-content">
        <div class="breadcrumbs breadcrumbs-fixed" id="breadcrumbs">
            <h3>
                <span class="hidden-320 ng-binding">Phân Quyền - Danh Sách Nhóm</span>
            </h3>
                ...
                <div class="modal-container" v-if="addModal == 2">
                    <div class="container-popup  col-xs-4">
                        <div class="breadcrumbs">
                            <h3>
                                <span class="hidden-320 ng-binding">Thêm Nhóm Phân Quyền</span>
                            </h3>
    ...
    methods: {
        ...
        confirmAddData() {
            ...
            Swal.fire({
                ...
                $.ajax({
                    type: 'POST',
                    url: '/admin/group-permission/add',
                    data: body,
        ...
        confirmEditData(_i) {
            Swal.fire({
                ...
                $.ajax({
                    type: 'POST',
                    url: '/admin/group-permission/edit/'+_i.id,
                    data: body,
                    success: function(data){
                        _i.edit = 1;
                        this.loadingTable = 0;
        ...
        deleteRecore(_i) {
            ...
            Swal.fire({
                ...
                that.loadingTable = 1;
                $.ajax({
                    url: "/admin/group-permission/delete/"+_i.id,
                    type: 'GET',
                    dataType: 'json',
        ...
        onLoadPagination() {
            ...
            $.ajax({
                type: 'GET',
                url: "{{route('admin.getGroupPermissions')}}?page=" + this.page + "&name=" + this.conditionName,
                success: function(data){
                    if (data.count > 0) {
                        data.data.map(item => {
                            item.edit = 1;
