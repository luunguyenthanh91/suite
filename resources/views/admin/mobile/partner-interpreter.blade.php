            ...
            <div class="modal-dialog ">
                <div class="modal-content" >
                    ...
                    <div class="modal-header">
                        <h4 class="modal-title">{{ trans('label.detail') }}</h4>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            <div class="form-group col-lg-12">
                                <label class="form-label">{{ trans('label.id_item') }}</label>
                            ...
                            <div class="d-flex col-lg-12">
                                <div class="fullWidth">
                                    <div class="search-form"> 
                                        <input type="text" class="form-control search" v-model="conditionAddress" placeholder="{{ trans('label.matching2') }}">
                                        <button class="btn btn-outline-secondary3 searchBtn" @click="onMatching()">
                            ...
                            <div class="bodyContentRight tableFixHead">
                                <table id="gridTable" class="table thead-border-top-0 table-nowrap mb-0 mt-10">
                                    <thead class="thead-light">
                                        <tr>
                                            <th scope="col" @click="sort('id')" style="width: 100%; ">
                                                <div v-bind:class="[sortBy === 'id' ? sortDirection : '']">{{ trans('label.interpreter') }}</div>
                                            </th>
                                        </tr>
                                    </thead>
                                        ...
                                        <tr v-for="item in sortedProducts">
                                            ...
                                            <div>
                                                <a type="button" class="btn btn-outline-secondary" target="_blank" :href="'/admin/partner-interpreter-view/' + item.id">
                                                    <i class="fas fa-info-circle"><span class="labelButton">((item.id))</span></i>
                                                </a>
                                                <a type="button" class="btn btn-outline-secondary3"  style="background:darkviolet" @click="copyClipboadCTVpd(item)">
                                                    <i class="fa fa-clipboard"></i>
                                                </a>
                                            </div>
                                            <div>(( parseName(item.name) ))</div>
                                            <div v-if='item.male == 1'>{{ trans('label.male') }}</div>
                                            <div v-if='item.male == 2'>{{ trans('label.female') }}</div>
                                            <div>(( parseName(item.address) ))</div>
                                            <div>(( parsePhone(item.phone) ))
                                                <a type="button" class="btn btn-outline-secondary3" style="background:limegreen" :href="'tel:'+item.phone">
                                                    <i class="fas fa-phone"></i>
                                                </a>
                                            </div>
                                            <div>(( item.email ))</div>
                                            <div>
                                                <span v-if='item.lever_nihongo == 1'>N1</span>
                                                <span v-if='item.lever_nihongo == 2'>N2</span>
                                                <span v-if='item.lever_nihongo == 3'>N3</span>
                                                <span v-if='item.lever_nihongo == 4'>N4</span>
                                                <span v-if='item.lever_nihongo == 5'>N5</span>
                                                (JLPT:
                                                <span v-if='item.lever_nihongo == 1'>N1</span>
                                                <span v-if='item.lever_nihongo == 2'>N2</span>
                                                <span v-if='item.lever_nihongo == 3'>N3</span>
                                            ...
                                            <p v-if="item.distance">(( parseInt(item.distance) )) {{ trans('label.km') }}</p>
...
new Vue({
    ...
    data: {
        ...
        groups: [],
        conditionStatus: '',
        conditionAddress: '{{ Request::get("keyword") }}',
        ngay_phien_dich: '',
