    ...
    <div id="list-data">
            ...
            <div class="modal-dialog char-h-mobile">
                <div class="modal-content" >
                    ...
                    <div class="page-separator">
                        ...
                        <div class="page-separator">
                            <div class="page-separator__text">
                            {{ trans("label.graph") }}( {{ trans("label.cost1") }})
                            </div>
                        </div>
                        <div class="card">
                            <div class="col-lg-12">
        ...
        <div class="modal fade" id="myModalChartMonth">
            <div class="modal-dialog char-h-mobile">
                <div class="modal-content" >
                    <div class="modal-header">
                        <h4 class="modal-title">{{ trans('label.sale_cost_chart') }}</h4>
                        <button type="button" class="close" data-dismiss="modal">&times;</button>
                    </div>
                    <div class="modal-body">
        ...
        <div class="modal fade" id="myModalChartYear">
            <div class="modal-dialog char-h-mobile">
                <div class="modal-content" >
                    <div class="modal-header">
                        <h4 class="modal-title">{{ trans('label.sale_cost_year_chart') }}</h4>
                        <button type="button" class="close" data-dismiss="modal">&times;</button>
                    </div>
                    <div class="modal-body">
        ...
        <div class="row">
            <div class="bodyButtonTopMobile fullWidthMobile">
                <a type="button" class="btn btn-outline-secondary3 pdfButtonBg" target="_blank" :href="'/admin/cost-pdf?' + conditionSearch">
                        ...
                        <tbody class="list" id="search">
                            <tr v-for="item in sortedProducts">
                                ...
                                <a type="button" class="btn btn-outline-secondary" target="_blank" :href="'/admin/projectview/' + item.id">
                                    ...
                                    {{ trans('label.sale_cost') }}=<span class="moneyCol" >(( new Intl.NumberFormat('ja-JP', { style: 'currency', currency: 'JPY',currencyDisplay: 'name' }).format(item.sumPhiSale) ))</span><br>
                                    ...
                                    {{ trans('label.total2') }}=<span class="moneyCol" >(( new Intl.NumberFormat('ja-JP', { style: 'currency', currency: 'JPY',currencyDisplay: 'name' }).format(item.sumCostAll) ))
                                    </span>
                                </td>
                            </tr>
                        </tbody>
    ...
    methods: {
        ...
        loadChartMonth() {
            ...
            setTimeout(function(){ 
                ...
                seriesColors: ['#90EE90', '#ffb7c5', 'blue', '#9BBB59', '#F79646', 'red', '#948A54', '#4000E3'],
                series:[
        ...
        loadChartYear() {
            ...
            setTimeout(function(){ 
                plot6 = $.jqplot('chart7', [s1,s2,s3,s4,s5,s6], {
                    captureRightClick: true,
                // Only animate if we're not using excanvas (not in IE 7 or IE 8)..
                animate: !$.jqplot.use_excanvas,
                cursor: {
            ...
            $.ajax({
                ...
                success: function(data) {
                    if (data.count > 0) {
                        ...
                        that.everyYearReportCost = data.everyYearReportCost;
                    } else {
                        that.count = 0;
                        that.sumCount = data.count;
                        that.list = [];
                        ...
                        that.sumCostIncomeTax= 0;
                        that.sumCostMoveFee= 0;
                        that.sumCostBankFee= 0;
                        that.everyYearReportCost = [];
                    }
                    that.loadingTable = 0;
                    let pageArr = [];
                    if (that.page - 2 > 0) {
