    ...
    <div id="list-data">
        ...
        <div class="row">
            <div class="bodyButtonTopMobile fullWidthMobile">
                <a type="button" class="btn btn-outline-secondary3"  style="background:orange" @click="copyClipboadCTVpd(data)">
                    <i class="fa fa-clipboard"><span class="labelButton">{{ trans('label.copy_clipboard') }}</span></i>
                </a>
                <a type="button" class="btn btn-outline-secondary3" style="background:green" href="/admin/partner-interpreter-update/{{$id}}">
                    <i class="fas fa-edit"><span class="labelButton">{{ trans('label.edit') }}</span></i>
                </a>
                <a type="button" class="btn btn-outline-secondary3" style="background:red" @click="deleteRecore('{{$id}}')" v-if='{{@$data->status}} == 0 || {{@$data->status}} == ""'>
        ...
        <div class="col-lg-12">
            <div style="col-lg-auto">
                <div style="width:100%;text-align:left !important;">
                    ...
                    <br>
                    @if ( @$data->male == 1 )
                        <i class="fa fa-male maleClass"></i>
                    @endif
                    @if ( @$data->male == 2 )
                        <i class="fa fa-female femaleClass"></i>
                    @endif
                    ...
                    <a target="_blank" href="tel:{{@$data->phone}}">
                        {{ trans('label.tel2') }}: (( parsePhone('{{@$data->phone}}') ))
                    </a>
                </div>
            </div>
        </div>
                            ...
                            <div class="row">                        
                                <table class="table thead-border-top-0 table-nowrap table-mobile propertiesTables">   
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                            <div class="d-flex">
                                                <div class="fullWidth">{{@$data->address}}</div>
                                                <a target="_blank" href="http://maps.google.com/maps?q={{@$data->address}}" id="link-map-address" type="button" class="btn btn-outline-secondary">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                            <a target="_blank" href="tel:{{@$data->phone}}">(( parsePhone('{{@$data->phone}}') ))</a>
                                            <!-- <a target="_blank" href="tel:{{@$data->phone}}" id="link-map-address" style="background-color:Brown;" class="btn btn-outline-secondary3">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex">
                                                    <div class="fullWidth">{{@$data->email}}</div>
                                                    <a target="_blank" href="mailto:{{@$data->email}}" id="link-map-address" style="background-color:DarkOrchid;" type="button" class="btn btn-outline-secondary">
                        ...
                        <div class="tab-pane" id="detailtab4">
                            ...
                            <table class="table thead-border-top-0 table-nowrap table-mobile propertiesTables">   
                                        <tr>
                                            ...
                                            <td>
                                            @if ( @$data->lever_nihongo == 1 )
                                                <span>N1</span>
                                            @endif
                                            @if ( @$data->lever_nihongo == 2 )
                                                <span>N2</span>
                                            @endif
                                            @if ( @$data->lever_nihongo == 3 )
                                                <span>N3</span>
                                            @endif
                                            @if ( @$data->lever_nihongo == 4 )
                                                <span>N4</span>
                                            @endif
                                            @if ( @$data->lever_nihongo == 5 )
                                                <span>N5</span>
                                            @endif
                                            </td>
                                        </tr> 
                        ...
                        <div class="tab-pane" id="detailtab2">
                            ...
                            <table class="table thead-border-top-0 table-nowrap table-mobile propertiesTables">   
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                            (( parseName('{{@$data->ten_chutaikhoan}}') ))
                                            </td>
                                        </tr> 
                                    </table>  
                            </div>
                                ...
                                <table id="gridTable" class="table thead-border-top-0 table-nowrap mb-0">
                                    ...
                                    <tbody class="list" id="search">
                                        ...
                                        <td :class="item.classStyle  + ' sticky-col fix-col1-detail'" style="left:0px">
                                            ...
                                            {{ trans('label.interpreter_cost') }}: (( new Intl.NumberFormat('ja-JP', { style: 'currency', currency: 'JPY',currencyDisplay: 'name' }).format(item.sumPhPhienDich) ))<br>
                                            {{ trans('label.move_fee') }}: (( new Intl.NumberFormat('ja-JP', { style: 'currency', currency: 'JPY',currencyDisplay: 'name' }).format(item.sumPhiGiaoThong) ))<br>
                                            {{ trans('label.total2') }}: (( new Intl.NumberFormat('ja-JP', { style: 'currency', currency: 'JPY',currencyDisplay: 'name' }).format(item.sumSendPhienDich) ))<br>
...
new Vue({
    ...
    methods: {
        ...
        copyClipboadLink(_i) {
            ...
            var url = baseUrl + "/partner-interpreter-view/" + _i.id;
            $('#copyName').html(url);
            $('#copyFurigana').html("");
            $('#copyPhone').html("");
            ...
            Swal.fire({
                ...
                $.ajax({
                    ...
                    success: function(res) {
                        ...
                        location.href = "/admin/partner-interpreter-view/" + _i;
                    },
                    error: function(xhr, textStatus, error) {
                        Swal.fire({
                            title: "エラーが発生しました!",
        ...
        promoteApprove(_i) {
            ...
            Swal.fire({
                ...
                that.loadingTable = 1;
                $.ajax({
                    url: "/admin/interpreterapprove/" + _i,
                    type: 'GET',
                    dataType: 'json',
                    success: function(res) {
                        Swal.fire({
        ...
        deleteRecore(_i) {
            ...
            Swal.fire({
                ...
                that.loadingTable = 1;
                $.ajax({
                    url: "/admin/partner-interpreter-delete/" + _i,
                    type: 'GET',
                    dataType: 'json',
                    success: function(res) {
                        Swal.fire({
                        ...
                        location.href = "/admin/partner-interpreter";
                    },
                    error: function(xhr, textStatus, error) {
                        Swal.fire({
                            title: "Có lỗi dữ liệu nhập vào!",
        ...
        onLoadPagination() {
            ...
            // }
            conditionSearch += '&ctv_pd_id=' + this.interpreter_id;
