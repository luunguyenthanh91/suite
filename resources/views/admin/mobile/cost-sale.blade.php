    ...
    <div id="list-data">
            ...
            <div class="modal-dialog char-h-mobile">
                <div class="modal-content" >
                    ...
                    <div class="page-separator">
                                ...
                                <div class="row" style="margin-top:15px;">
                                    <div class="form-group col-lg-12">
                                        <a class="dropdown-item" target="_blank" @click="lastMonthProject()">
                                            <i class="fas fa-search-plus"></i><span class="labelButtonDropMenu">{{ trans('label.lastmonth_cost') }}</span>
                                        </a>  
                                        <a class="dropdown-item" target="_blank" @click="thisMonthProject()">
                                            <i class="fas fa-search-plus"></i><span class="labelButtonDropMenu">{{ trans('label.thismonth_cost') }}</span>
                                        </a>  
                                        <a class="dropdown-item" target="_blank" @click="thisYearProject()">
                                            <i class="fas fa-search-plus"></i><span class="labelButtonDropMenu">{{ trans('label.thisyear_cost') }}</span>
                                        </a> 
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="page-separator">
                            <div class="page-separator__text">
                            {{ trans("label.graph") }}( {{ trans("label.sale_cost") }})
                            </div>
                        </div>
                        <div class="card">
                            <div class="col-lg-12">
                ...
                <div class="modal-content" >
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-lg-12">
                                <input type="checkbox" id="checkedPayStatus0" value="0" v-model="checkedPayStatus">
                                <label for="checkedPayStatus0">{{ trans('label.bank_status_0') }}</label>
                            </div>
                            <div class="form-group col-lg-12">
                                <input type="checkbox" id="checkedPayStatus1" value="1" v-model="checkedPayStatus">
                                <label for="checkedPayStatus1">{{ trans('label.bank_status_1') }}</label>
                            </div>
                        </div>
                        <div class="page-separator-line"></div>
                        <div class="row">
        ...
        <div class="modal fade" id="myModalChartMonth">
            <div class="modal-dialog char-h-mobile">
                <div class="modal-content" >
                    <div class="modal-header">
                        <h4 class="modal-title">{{ trans('label.sale_cost_chart_sale') }}</h4>
                        <button type="button" class="close" data-dismiss="modal">&times;</button>
                    </div>
                    <div class="modal-body">
        ...
        <div class="modal fade" id="myModalChartYear">
            <div class="modal-dialog char-h-mobile">
                <div class="modal-content" >
                    <div class="modal-header">
                        <h4 class="modal-title">{{ trans('label.sale_cost_year_chart_sale') }}</h4>
                        <button type="button" class="close" data-dismiss="modal">&times;</button>
                    </div>
                    <div class="modal-body">
        ...
        <div class="row">
            <div class="bodyButtonTopMobile fullWidthMobile">
                <a type="button" class="btn btn-outline-secondary3 pdfButtonBg" target="_blank" :href="'/admin/cost-sale-pdf?' + conditionSearch">
                        ...
                        <tbody class="list" id="search">
                            <tr v-for="item in sortedProducts">
                                ...
                                <a type="button" class="btn btn-outline-secondary" target="_blank" :href="'/admin/projectview/' + item.id">
                                    ...
                                    {{ trans('label.sale_cost') }}=<span class="moneyCol" >(( new Intl.NumberFormat('ja-JP', { style: 'currency', currency: 'JPY',currencyDisplay: 'name' }).format(item.sumPhiSale) ))</span>
                                </td>
                            </tr>
                        </tbody>
                    </table>                       
...
new Vue({
    ...
    methods: {
        ...
        notPaySearchPDF: function() {
            this.notPaySearch();
            location.href = "/admin/cost-sale-pdf?notpay=1&"+this.conditionSearch;
        },
        ...
        onLoadPagination() {
            ...
            if (this.ngay_chuyen_khoan != '') {
                conditionSearch += '&ngay_chuyen_khoan_sale=' + this.ngay_chuyen_khoan;
            }
            if (this.thang_chuyen_khoan != '') {
                conditionSearch += '&thang_chuyen_khoan_sale=' + this.thang_chuyen_khoan;
            }
            if (this.name_kh != '') {
            ...
            if (this.checkedCostStatus.length > 0) {
                conditionSearch += '&check_cost_sale_status=' + this.checkedCostStatus.join();
            }
            if (this.checkedPayStatus.length > 0) {
                conditionSearch += '&check_pay_sale_status=' + this.checkedPayStatus.join();
            }
            if (this.sortName != '') {
            ...
            $.ajax({
                ...
                success: function(data) {
                    if (data.count > 0) {
                        ...
                        that.sumCost = data.sumCostSale;
                        that.yearReportSale = data.yearReportSale;
                        that.everyYearReportSale = data.everyYearReportSale;
                    } else {
                        that.count = 0;
                        that.sumCount = data.count;
                        that.list = [];
