    ...
    <div id="list-data">
            ...
            <div class="modal-dialog char-h-mobile">
                <div class="modal-content" >
                    ...
                    <div class="modal-body">
                        ...
                        <div class="page-separator">
                            <div class="page-separator__text">
                            {{ trans("label.graph") }}( {{ trans("label.interpreter_tax") }})
                            </div>
                        </div>
                        <div class="card">
                            <div class="col-lg-12">
            ...
            <div class="modal-dialog char-h-mobile">
                <div class="modal-content" >
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            <div class="form-group col-lg-12">
                                <label class="form-label">{{ trans('label.tax_date') }}</label>
                                <input type="date" class="form-control search" v-model="paytaxdate" min="2021-03-17">
                            </div>
                            <div class="form-group col-lg-12">                        
                                <label class="form-label">{{ trans('label.tax_date_month') }}</label>
                                <input type="month" class="form-control search"  v-model="thang_paytaxdate"  min="2021-03">
                            </div>
                        </div>
                        <div class="page-separator-line"></div>
                        <div class="row">
                            <div class="form-group col-lg-12">
                                <label class="form-label">{{ trans('label.tax_status') }}</label>
                            </div>
                            <div class="form-group col-lg-12">
                                <input type="checkbox" id="checkedTaxStatus0" value="0" v-model="checkedTaxStatus">
                                <label for="checkedTaxStatus0">{{ trans('label.bank_status_0') }}</label>
                            </div>
                            <div class="form-group col-lg-12">
                                <input type="checkbox" id="checkedTaxStatus1" value="1" v-model="checkedTaxStatus">
                                <label for="checkedTaxStatus1">{{ trans('label.bank_status_1') }}</label>
                            </div>
                        </div>
                        <div class="page-separator-line"></div>
                        <div class="row">
        ...
        <div class="modal fade" id="myModalChartMonth">
            <div class="modal-dialog char-h-mobile">
                <div class="modal-content" >
                    <div class="modal-header">
                        <h4 class="modal-title">{{ trans('label.tax_cost_movefee_chart') }}</h4>
                        <button type="button" class="close" data-dismiss="modal">&times;</button>
                    </div>
                    <div class="modal-body">
        ...
        <div class="modal fade" id="myModalChartYear">
            <div class="modal-dialog char-h-mobile">
                <div class="modal-content" >
                    <div class="modal-header">
                        <h4 class="modal-title">{{ trans('label.tax_cost_year_chart') }}</h4>
                        <button type="button" class="close" data-dismiss="modal">&times;</button>
                    </div>
                    <div class="modal-body">
        ...
        <div class="row">
            <div class="bodyButtonTopMobile fullWidthMobile">
                <a type="button" class="btn btn-outline-secondary3 pdfButtonBg" target="_blank" :href="'/admin/cost-incometax-pdf?' + conditionSearch">
                        ...
                        <tbody class="list" id="search">
                            <tr v-for="item in sortedProducts">
                                ...
                                <a type="button" class="btn btn-outline-secondary" target="_blank" :href="'/admin/projectview/' + item.id">
                                    ...
                                    {{ trans('label.tax') }}=<span class="moneyCol" >(( new Intl.NumberFormat('ja-JP', { style: 'currency', currency: 'JPY',currencyDisplay: 'name' }).format(item.sumThuePhienDich) ))</span><br>
                                    </span>
                                </td>
                            </tr>
                        </tbody>
    ...
    methods: {
        ...
        loadChartMonth() {
            ...
            setTimeout(function(){ 
                ...
                series:[
                    { label: '{{ trans("label.interpreter_tax") }}' ,
        ...
        clearSearchCondition() {
            ...
            this.paytaxdate = '';
            this.thang_paytaxdate = '';
            this.checkedCostStatus = [0,1];
            this.checkedTaxStatus = [];
        ...
        notPaySearch: function() {
            ...
            this.ngay_phien_dich_to = this.formatDate(lastDayOfPreviousMonth);
            this.checkedTaxStatus = [0];
            this.sortName = 'ngay_pd';  
            this.sortType = "ASC";  
            this.sortBy= 'ngay_pd';
            this.sortDirection= 'ASC';
        ...
        notPaySearchPDF: function() {
            this.notPaySearch();
            location.href = "/admin/cost-incometax-pdf?notpay=1&"+this.conditionSearch;
        },
        refresh: function() {
            this.clearSearchCondition();
            this.onLoadPagination();
        ...
        onLoadPagination() {
            ...
            if (this.paytaxdate != '') {
                conditionSearch += '&paytaxdate=' + this.paytaxdate;
            }
            if (this.thang_paytaxdate != '') {
                conditionSearch += '&thang_paytaxdate=' + this.thang_paytaxdate;
            }
            ...
            if (this.checkedCostStatus.length > 0) {
                conditionSearch += '&check_cost_incometax_status=' + this.checkedCostStatus.join();
            }
            if (this.checkedTaxStatus.length > 0) {
                conditionSearch += '&check_pay_cost_incometax_status=' + this.checkedTaxStatus.join();
            }
            if (this.sortName != '') {
            ...
            $.ajax({
                ...
                success: function(data) {
                    if (data.count > 0) {
                        ...
                        that.sumCost = data.sumCostIncomeTax;
                        that.sumCostInterpreter = data.sumCostInterpreter;
                        that.yearReportThuePhienDich = data.yearReportThuePhienDich;
                        that.everyYearReportThuePhienDich = data.everyYearReportThuePhienDich;
                    } else {
                        that.count = 0;
                        that.sumCount = data.count;
                        that.list = [];
                        that.sumCost = 0;
                        that.sumCostInterpreter = 0;
                        that.yearReportThuePhienDich = [];
                        that.everyYearReportThuePhienDich = [];
                    }
                    that.loadingTable = 0;
                    let pageArr = [];
                    if (that.page - 2 > 0) {
