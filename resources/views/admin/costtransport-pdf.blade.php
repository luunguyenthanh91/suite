...
<body>
    <div style="margin-top:10px;margin-bottom:10px; margin-left:10px;margin-right:10px;">
        ...
        <div style='text-align:center; vertical-align:middle; height:45px;width:100%;border-bottom:2px solid black'>
            <div style="font-size:24;"><b>{{ trans('label.costtransport_pdf2') }}</b></div>
        </div>
        ...
        <table style='width:100%;border-collapse:collapse;margin-top:20px;font-size:10.5'>
            ...
            <tr>
                ...
                @if ( @$item['type'] == 1 )
                    <span>{{ trans('label.type_transport1') }}</span>
                @endif
                @if ( @$item['type'] == 2 )
                    <span>{{ trans('label.type_transport2') }}</span>
                @endif
                @if ( @$item['type'] == 3 )
                    <span>{{ trans('label.type_transport3') }}</span>
                @endif
                @if ( @$item['type'] == 4 )
                    <span>{{ trans('label.type_transport4') }}</span>
                @endif
