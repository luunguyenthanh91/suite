    ...
    <table id="customers">
        <tr>
            <td colspan="6" style="vertical-align:top;text-align:center">
                <div style="font-size:24;">振込手数料一覧表</div>    
                <div>(通訳事業)</div>
            </td>
        </tr>
    ...
    <tr style="width:100%;">
        <td colspan="3">
            <table id="customers2"> 
                ...
                <tr>
                    <td class="bgRowHeaderPDF">振込手数料合計：</td>
                    <td>¥{{ number_format($data->sumPay) }}</td>
                </tr>
                <tr>
                    <td class="bgRowHeaderPDF">振込月：</td>
                    <td>{{$data->selectedMonth}}</td>
                </tr>
            </table>
        </td>
        <td></td>
        <td colspan="1" style="z-index:1000;text-align:right;width:100%;">
            <table id="customers3"> 
                <tr>
...
@else 
        ...
        <tr>
            <td rowspan="2" class="bgRowHeaderPDF border-all title_form" style="width:300px">案件</td>
            <td colspan="3" class="bgRowHeaderPDF border-all title_form" style="width:70px">振込手数料</td>
            <td rowspan="2" class="bgRowHeaderPDF border-all title_form" >確認者</td>
            <td rowspan="2" class="bgRowHeaderPDF border-all title_form" >承認者</td>
        </tr>
            <tr>
                <td class="bgRowHeaderPDF border-all title_form" style="width:70px">営業報酬</td>
                <td class="bgRowHeaderPDF border-all title_form" style="width:70px">通訳給与</td>
                <td class="bgRowHeaderPDF border-all title_form" style="width:70px">合計</td>
            </tr>
            @foreach($data as $item)
                <tr>
                    <td class="border-all data_form"  style="vertical-align:top">
                        ...
                        <span>{{$item->address_pd_short}}</span><br>
                        <span>営業者：
                    ...
                    <td class="border-all data_form" style="vertical-align:top;text-align:right">
                        <span>{{$item->sumPhiChuyenKhoanSale}}</span>
                    </td>
                    <td  class="border-all data_form" style="vertical-align:top;text-align:right">
                        <span>{{$item->sumPhiChuyenKhoanPD}}</span>
                    </td>
                    <td class="border-all data_form" style="vertical-align:top;text-align:right">
                        <span>{{$item->sum_phi_chuyen_khoan}}</span>
                    </td>
