...
<div class="mdk-drawer-layout__content page-content page-notscrool3">
    ...
    <div id="list-data">
                    ...
                    <div class="modal-body">
                        <div class="table-responsive">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-lg-12">
                                    <input type="checkbox" id="checkedMoveStatus1" value="0" v-model="checkedMoveStatus" @change="someHandlerChange()">
                                    <label for="checkedMoveStatus1">なし</label>
                                </div>
                                <div class="form-group col-lg-12">
                                    <input type="checkbox" id="checkedMoveStatus0" value="1" v-model="checkedMoveStatus" @change="someHandlerChange()">
                                    <label for="checkedMoveStatus0">あり</label>
                                </div>
                            </div>
                            <div class="row">
                                <div class="form-group col-lg-12">
                                ...
                                <div class="form-group col-lg-12">
                                    <input type="checkbox" id="checkedReceiptStatus0" value="0" v-model="checkedReceiptStatus" @change="someHandlerChange()">
                                    <label for="checkedReceiptStatus0">なし</label>
                                </div>
                                <div class="form-group col-lg-12">
                                    <input type="checkbox" id="checkedReceiptStatus1" value="1" v-model="checkedReceiptStatus" @change="someHandlerChange()">
        ...
        <div class="bodyButtonTop">
            <a type="button" class="btn btn-outline-secondary3" style="background:green" :href="'/admin/move-fee-pdf?' + conditionSearch">
                <i class="fas fa-file-pdf"><span class="labelButton">交通費一覧表(PDF)</span></i>
            </a> 
            ...
            <div class="row page_container_custom_marginright">
                <div :class="''+classColLG12">
                    <div :class="'' + classBodayRightContentGrid">
                        ...
                        <h5 class="threadLabelCenter">交通費合計：(( new Intl.NumberFormat('ja-JP', { style: 'currency', currency: 'JPY' }).format(sumPay) ))</h5>
                            ...
                            <table id="gridTable" class="table thead-border-top-0 table-nowrap">
                                        <thead class="thead-light">
                                            <tr>
                                                ...
                                                <th scope="col" v-if='type_show == 1'>
                                                    <div class="threadLabelCenter">領収書</div>
                                                </th>
                                        ...
                                        <tbody class="list" id="search">
                                            <tr v-for="item in list">
                                                    ...
                                                    <p class="rowContent">
                                                        <table class="m-0 table thead-border-top-0 table-nowrap table-mobile">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <div v-for="itemCTV in item.date_list" >
                                                                        <a v-if=" itemCTV.file_hoa_don " type="button" class="btn btn-outline-secondary3" style="background:#f38434" target="_blank" :href="'/admin/move-fee-receipt-pdf/' + item.id">
                                                                            <i class="fas fa-download"><span class="labelButton">領収書</span></i>
                                                                        </a> 
                                                                    </div>
                                                                    <div v-if="item.file_hoa_don_status == 0">
                                                                        なし
                                                                    </div>
                                                                </td>
                                                            </tr>
                                                ...
                                                <td v-if='type_show == 1' style="text-align:center;">
                                                    <div v-for="itemCTV in item.date_list" >
                                                        <a v-if=" itemCTV.file_hoa_don " type="button" class="btn btn-outline-secondary3" style="background:#f38434" target="_blank" :href="'/admin/move-fee-receipt-pdf/' + item.id">
                                                            <i class="fas fa-download"><span class="labelButton">領収書</span></i>
                                                        </a> 
...
new Vue({
    ...
    data: {
        ...
        checkedMoveStatus: [1],
        checkedReceiptStatus: [0,1],
        typePay:[1,2],
        checkedSaleFeeStatus: [1],
        showCount: '0',
    ...
    methods: {
        ...
        clearSearch() {
            ...
            this.checkedMoveStatus = [0,1];
            this.checkedReceiptStatus = [0,1];
            this.typePay = [1,2];
            this.checkedSaleFeeStatus = [0,1];
        ...
        onLoadPagination() {
            ...
            if (this.checkedMoveStatus.length > 0) {
                conditionSearch += '&loai_move_status=' + this.checkedMoveStatus.join();
            }
            if (this.checkedReceiptStatus.length > 0) {
                conditionSearch += '&loai_receipt_status=' + this.checkedReceiptStatus.join();
            }
            if (this.typePay.length > 0) {
                conditionSearch += '&typePay=' + this.typePay.join();
            }
            if (this.checkedSaleFeeStatus.length > 0) {
                conditionSearch += '&loai_status_sale_fee_multi=' + this.checkedSaleFeeStatus.join();
            }
            ...
            $.ajax({
                type: 'GET',
                url: "{{route('admin.getListMoveFee')}}?page=" + this.page  + conditionSearch ,
