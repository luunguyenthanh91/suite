...
<div class="mdk-drawer-layout__content page-content page-notscrool">
    ...
    <div id="list-data" style="background:white !important;">
                ...
                <div class="modal-content" >
                    ...
                    <div class="modal-body">
                        <div class="form-group col-lg-12">
                            <label class="form-label">{{ trans('label.cost_transport_name2') }}</label>
        ...
        <div class="modal fade" id="myModal">
            <div class="modal-dialog  char-w-new">
                <div class="modal-content" >
                    ...
                    <div class="modal-body">
                        <div class="form-group col-lg-12">
                            <label class="form-label">{{ trans('label.request_cost_id') }}</label>
        ...
        <div class="splitter" >
            <div id="first" class="leftPanel" style="width:0px !important;">
                <div class="col-lg-12" style="margin-top:35px;">
                </div>
            </div>
            <div id="separator"></div>
            <div id="second" class="rightPanel" style="width:100% !important;">
                <div class="bodyButtonTop">
                    <a type="button" class="btn btn-outline-secondary3 newButtonBg" data-toggle="modal" data-target="#create">
                            ...
                            <div :class="'' + classBodayRightContentGrid">
                                <div class="d-flex ">
                                    ...
                                    <div class="d-flex rightGridMenu">
                                        ...
                                        <div class="vl"></div>
                                        <a @click="resetSearch()" type="button" class="btn btn-outline-secondary3 updateButton updateButtonWidth">
                                            <i class="fas fa-sync-alt">{{ trans('label.refresh') }}</i>
                                        </a>
                                    </div>
                                </div>
