                        ...
                        <div style="margin-left:20px;padding:10px;">
                            ...
                            <table style="border:0px;font-size:14px;">
                                <tr>
                                    ...
                                    <td>
                                        <div style="margin-left:10px;">{{ $data->employee_depname }}</div>
                                    </td>
                                </tr>
                                <tr>
                                    <td>{{ trans('label.user_name') }}</td>
                                    <td>
                                        <div style="margin-left:10px;">({{ $data->employee_code }}) {{ $data->employee_name }} {{ trans('label.sama') }}</div>
                                    </td>
                                </tr>
                            </table>
                        </div>
            ...
            <tr>
                ...
                <td>
                    <table style='border-collapse:collapse;font-size:10.5;border:0.1px solid black;'>
                        ...
                        <tr>
                            <td class="border-all3" style="height:443px;vertical-align:top;">
                                <table style='width:100%;border-collapse:collapse;font-size:10.5;border:0px'>
                                    <tr>
                            ...
                            <td class="border-all3 title_form" style="height:83px;vertical-align:middle;text-align:center;">
                                <table style='width:100%;border-collapse:collapse;font-size:10.5;border:0px'>
                                    <tr>
                                        ...
                                        <td class="title_form border-all31 " style="width:110px;height:26px;vertical-align:middle;text-align:center;padding-right:10px;;">
                                    ...
                                    <tr>
                                        ...
                                        <td class="title_form" style="width:110px;height:26px;vertical-align:middle;text-align:center;padding-right:10px;;">
