    ...
    <div class="page-content">
        <form method="post" action="">
            ...
            <div class="breadcrumbs breadcrumbs-fixed" id="breadcrumbs">
                <h3>
                    <span class="hidden-320 ng-binding">Chỉnh Sửa Nhà Phân Phối</span>
                </h3>
                <div class="toolbar">
                    <button class="btn btn-primary btn-primary" type="submit">
                        <i class="icon-pencil white"></i>
                        <span class="hidden-480">Thay Đổi</span>
                    </button>
                </div>
            </div>
                                ...
                                <div class="tab-content">
                                            ...
                                            <div class="form-group c_form_group ">
                                                ...
                                                <div class="input-group">
                                                    <input type="text" class="form-control" placeholder="Họ Và Tên"
                                                        aria-label="Họ Và Tên" name="name" value="{{$data->name}}"
                                            ...
                                            <div class="form-group c_form_group ">
                                                ...
                                                <div class="input-group">
                                                    <input type="text" class="form-control" placeholder="Nick Name"
                                                        ...
                                                        value="{{$data->nick_name}}" aria-describedby="basic-addon1"
                                                        required>
                                                </div>
                                            </div>
                                            <div class="form-group c_form_group ">
                                            ...
                                            <div class="form-group c_form_group">
                                                ...
                                                <div class="input-group">
                                                    <select class="custom-select" name="is_active">
                                                        <option value="1" @if($data->is_active==1) selected="selected"
                                                            @endif>Mở
                                                        </option>
                                                        <option value="0" @if($data->is_active==0) selected="selected"
                                                            @endif>Khóa
                                                        </option>
                                                    </select>
                                                </div>
                                            ...
                                            <div class="form-group c_form_group">
                                                ...
                                                <div class="input-group">
                                                    <select class="custom-select" name="is_debt">
                                                        <option value="1" @if($data->is_debt==1) selected="selected"
                                                            @endif>Công Nợ
                                                        </option>
                                                        <option value="0" @if($data->is_debt==0) selected="selected"
                                            ...
                                            <div class="form-group c_form_group ">
                                                ...
                                                <div class="input-group">
                                                    <input type="number" class="form-control"
                                                        ...
                                                        value="{{$data->paid_money}}" aria-describedby="basic-addon1">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group c_form_group ">
                                                ...
                                                <div class="input-group">
                                                    <input type="number" class="form-control" placeholder="Tiền Nợ"
                                                        name="debt_money" value="{{$data->debt_money}}"
                                                        aria-describedby="basic-addon1">
                                                </div>
                                            </div>
                                    ...
                                    <div id="messages" class="tab-pane fade row clearfix">
                                        ...
                                        <div class="col-lg-2 col-md-6 relative">
                                            <div class="checkbox">
                                                <label>
                                                    <input name="type[{{$item->id}}]" @if($item->checked == 1) checked @endif type="checkbox" class="ace"
                                                        value="1" />
