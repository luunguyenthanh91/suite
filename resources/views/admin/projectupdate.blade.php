...
<div class="mdk-drawer-layout__content page-content">
    ...
    <div id="list-data">
        ...
        <div class="bodyButtonLeft" v-if='isMobile == false'>
            <a type="button" class="btn btn-outline-secondary2 btn-submit" style="background:green" @click="onSubmit()">
                <i class="fas fa-save"><div class="labelButton">保存</div></i>
            </a>
            <a type="button" class="btn btn-outline-secondary2" style="background:red" href="/admin/projectview/{{$id}}">
                <i class="fas fa-window-close"><div class="labelButton">キャンセル</div></i>
            </a>           
        </div>
        <div class="bodyButtonTop" v-if='isMobile == true'>
            <a type="button" class="btn btn-outline-secondary3 btn-submit" style="background:green" @click="onSubmit()">
                <i class="fas fa-save"><div class="labelButton">保存</div></i>
            </a>
        ...
        <div class="container page__container page-section" :style="'margin-top: ' + marginTop + 'margin-left: ' + marginLeft">
