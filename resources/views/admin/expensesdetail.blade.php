...
@section('content')
@section('contentTitle', '経費支払い月')

<div class="mdk-drawer-layout__content page-content page-notscrool4">
    <!-- header    -->
    ...
    <div id="list-data">
        ...
        <div class="bodyButtonTop">
            <a type="button" class="btn btn-outline-secondary3" style="background:green" :href="'/admin/expenses-detail-pdf/{{$id}}?' + conditionSearch">
            ...
            <div class="row page_container_custom_marginright">
                <div :class="''+classColLG12">
                    <div :class="'' + classBodayRightContentGrid">
                        ...
                        <h5 class="threadLabelCenter">((selectedMonth))<br>経費合計：(( new Intl.NumberFormat('ja-JP', { style: 'currency', currency: 'JPY' }).format(sumPay) ))</h5>
                        ...
                        <div class="bodyContent">
                            ...
                            <div class="bodyContentLeft tableFixHead">
                                <table class="table mb-0 thead-border-top-0 table-nowrap">
                                    <thead class="thead-light">
                                        <tr>
                                            <th class="fullWidth flex-center">
                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="form-group col-lg-12">
                                                    <input type="checkbox" id="checkedReceiptStatus0" value="0" @change="someHandlerChange()" v-model="checkedCTVSex">
                                                    <label for="checkedReceiptStatus0">なし</label>
                                                </div>
                                                <div class="form-group col-lg-12">
                                                    <input type="checkbox" id="checkedReceiptStatus1" value="1" @change="someHandlerChange()" v-model="checkedCTVSex">
                                                    <label for="checkedReceiptStatus1">あり</label>
                                                </div>
                                            </div>
                                            <div class="page-separator-line"></div>
                            ...
                            <table id="gridTable" class="table thead-border-top-0 table-nowrap">
                                        <thead class="thead-light">
                                            <tr>
                                                <th style="width:100%;" v-if='type_show == 2'>
                                                    <div class="threadLabelCenter">経費</div>
                                                </th>
                                                <th v-if='type_show == 1'>
                                                    <div id="lblOrderNumber">日付 ▲</div>
                                                </th>
                                                <th v-if='type_show == 1'>
                                                    <div >勘定科目</div>
                                                </th>
                                                ...
                                                <th v-if='type_show == 1' style="width: 100%;"></th>
                                            </tr>
                                        </thead>
    ...
    methods: {
        ...
        deleteRecore(_i) {
            ...
            Swal.fire({
                ...
                that.loadingTable = 1;
                $.ajax({
                    url: "/admin/expensesdetaildelete/" + _i,
                    type: 'GET',
                    dataType: 'json',
        ...
        onLoadPagination() {
            ...
            $.ajax({
                type: 'GET',
                url: "{{route('admin.getListExpensesDetail')}}?id={{$id}}&page=" + this.page  + conditionSearch ,
                success: function(data) {
                    if (data.count > 0) {
                        data.dataChild.map(item => {
                            item.edit = 1;
                        });
                        that.count = data.pageTotal;
                        that.list = data.dataChild;
                        that.sumCount = data.count;
                        that.selectedMonth = data.selectedMonth;
                ...
                error: function(xhr, textStatus, error) {
                    Swal.fire({
                        title: "システムエラーが発生しました。 大変お手数でが、サイト管理者までご連絡ください。",
                        type: "warning",
