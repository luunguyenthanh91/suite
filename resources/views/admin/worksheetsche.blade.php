            ...
            <form method="POST" class="modal-dialog char-w-new" action="/admin/new-worksheet?type=1">
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title">{{ trans('label.new_worksheetsche') }}</h4>
                                            ...
                                            <tbody class="list" id="search">
                                                <tr v-for="item in sortedProducts">
                                                    <td :class="item.classStyle  + ' sticky-col fix-col1-detail'" style="left:0px">
                                                        <a target="_blank" :href="'/admin/worksheetsche-view/' + item.id">
                                                            ((item.id))
                                                        </a>
                                                    </td>
    ...
    new Vue({
        ...
        methods: {
            ...
            onLoadPagination() {
                ...
                $.ajax({
                    type: 'GET',
                    url: "{{route('admin.getListWorkSheet')}}?type=1&page=" + this.page + conditionSearch,
