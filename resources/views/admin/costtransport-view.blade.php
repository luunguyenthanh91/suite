...
@section('content')
@section('contentTitle', '旅費交通費申請ビュー')
...
<div class="mdk-drawer-layout__content page-content page-notscrool">
    ...
    <div id="list-data">
        <div class="bodyButtonTop">
            <a type="button" class="btn btn-outline-secondary3 background_sub_1" target="_blank" href="/admin/costtransport-pdf/{{$id}}">
                <i class="fa fa-file-pdf"><span class="labelButton">{{ trans('label.costtransport_pdf') }}</span></i>
            </a>  
            @if (Auth::guard('admin')->user()->id == 1 || $data->status == 1)
            <a type="button" class="btn btn-outline-secondary3" style="background:green" href="/admin/costtransport-update/{{$id}}">
                ...
                <div class="d-flex" style="width:100%;">
                    <div style="width:100%;text-align:left !important;">
                        <div class="col-lg-12" >
                            <label>
                            <u>
                                {{ trans('label.request_cost_id') }}{{@$data->id}} (
                                <span v-if='{{@$data->status}} == 0'>{{ trans('label.status0') }}</span>
                            ...
                            <br>
                            <label>{{@$data->employee_depname}} {{@$data->employee_name}} ({{@$data->employee_code}})</label>
                            <br>
                            <label>{{ trans('label.content') }}: {{@$data->name}}</label>
                            <br>
                            <label>{{ trans('label.money2') }}: 
                                        ...
                                        <table id="gridTable" class="table thead-border-top-0 table-nowrap mb-0">
                                            ...
                                            <tbody class="list" id="search">
                                                <tr v-for="item in sortedProducts">
                                                    ...
                                                    <td  >
                                                    <span v-if="item.type == 1">{{ trans('label.type_transport1') }}</span>
                                                    <span v-if="item.type == 2">{{ trans('label.type_transport2') }}</span>
                                                    <span v-if="item.type == 3">{{ trans('label.type_transport3') }}</span>
                                                    <span v-if="item.type == 4">{{ trans('label.type_transport4') }}</span>
                                                    </td>
                                                    <td  >
