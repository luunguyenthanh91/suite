                                    ...
                                    <div class="col-lg-12">
                                        <table class="table thead-border-top-0 table-nowrap table-mobile propertiesTables">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                <input type="text" name="nickname" v-model="nickname" class="form-control">
                                                </td>
                                            </tr>  
                                            <tr>
                                                <td>{{ trans('label.birthday') }}</td>
                                                <td>
                                                <input type="date" name="birthday" v-model="birthday" class="form-control">
                                                </td>
                                            </tr> 
                                            <tr>
                                                <td>{{ trans('label.email') }}</td>
                                                <td>
                                                <input type="text" name="email" v-model="phone" class="form-control">
                                                </td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                <input type="date" name="employ_date" v-model="employ_date" class="form-control">
                                                </td>
                                            </tr> 
                                            <tr>
