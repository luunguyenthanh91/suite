...
<div class="mdk-drawer-layout__content page-content page-notscrool3">
    ...
    <div id="list-data">
                ...
                <div class="modal-content" >
                    ...
                    <div class="modal-body">
                        <div class="table-responsive">
                            <div class="row standardColorSearch">
                                <div class="form-group col-lg-12">
                                    <label class="form-label">振込月</label>
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-lg-12">
                                <input type="checkbox" id="checkedMoveStatus1" value="0" v-model="checkedBankFeeStatus" @change="someHandlerChange()">
                                <label for="checkedMoveStatus1">なし</label>
                            </div>
                            <div class="form-group col-lg-12">
                                <input type="checkbox" id="checkedMoveStatus0" value="1" v-model="checkedBankFeeStatus" @change="someHandlerChange()">
        ...
        <div class="bodyButtonTop">
            <a type="button" class="btn btn-outline-secondary3" style="background:green" :href="'/admin/bank-fee-pdf?' + conditionSearch">
                <i class="fas fa-file-pdf"><span class="labelButton">振込料一覧表(PDF)</span></i>
            </a> 
            ...
            <div class="row page_container_custom_marginright">
                <div :class="''+classColLG12">
                    <div :class="'' + classBodayRightContentGrid">
                        ...
                        <h5 class="threadLabelCenter">振込料合計：(( new Intl.NumberFormat('ja-JP', { style: 'currency', currency: 'JPY' }).format(sumPay) ))</h5>
                            ...
                            <table id="gridTable" class="table thead-border-top-0 table-nowrap">
                                        <thead class="thead-light">
                                            <tr>
                                                ...
                                                <th scope="col" v-if='type_show == 1'>
                                                    <div class="threadLabelCenter">振込手数料(営業報酬)</div>
                                                </th>
                                                <th scope="col" v-if='type_show == 1'>
                                                    <div class="threadLabelCenter">振込手数料(通訳給与)</div>
                                                </th>
                                                <th scope="col" v-if='type_show == 1'>
                                                    <div class="threadLabelCenter">振込手数料合計</div>
                                                </th>
                                                ...
                                                <td v-if='type_show == 2' class="p-0 pl-2 pb-2 fullWidth">
                                                    <p class="rowContent">
                                                        <table class="m-0 table thead-border-top-0 table-nowrap table-mobile">
                                                            ...
                                                            <tr>
                                                                <td class="titleTd">振込手数料(営業報酬)：</td>
                                                                <td>
                                                                    (( new Intl.NumberFormat('ja-JP', { style: 'currency', currency: 'JPY' }).format(item.sumPhiChuyenKhoanSale) ))
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td class="titleTd">振込手数料(通訳給与)：</td>
                                                                <td>
                                                                    (( new Intl.NumberFormat('ja-JP', { style: 'currency', currency: 'JPY' }).format(item.sumPhiChuyenKhoanPD) ))
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td class="titleTd">振込手数料合計：</td>
                                                                <td>
                                                                    (( new Intl.NumberFormat('ja-JP', { style: 'currency', currency: 'JPY' }).format(item.sum_phi_chuyen_khoan) ))
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    </p>
...
new Vue({
    ...
    methods: {
        ...
        onLoadPagination() {
            ...
            if (this.checkedBankFeeStatus.length > 0) {
                conditionSearch += '&loai_bankfee_status=' + this.checkedBankFeeStatus.join();
            }
            ...
            $.ajax({
                type: 'GET',
                url: "{{route('admin.getListBankFee')}}?page=" + this.page  + conditionSearch ,
