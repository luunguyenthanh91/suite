...
<div class="mdk-drawer-layout__content page-content page-notscrool3">
    ...
    <div id="list-data">
                ...
                <div class="modal-content" >
                    ...
                    <div class="modal-body">
                        <div class="table-responsive">
                            ...
                            <div class="row">
                                <div class="form-group col-lg-12">
                                    <label class="form-label">振込状態</label>
                                </div>
                                <div class="form-group col-lg-12">
                            ...
                            <div class="row">
                                <div class="form-group col-lg-12">
                                    <label class="form-label">報酬受取</label>
                                </div>
                                <div class="form-group col-lg-12">
                                    <input type="checkbox" id="noSaleFee" value="0" v-model="checkedSaleFeeStatus" @change="someHandlerChange()">
                                    <label for="noSaleFee">なし</label>
                                </div>
                                <div class="form-group col-lg-12">
                                    <input type="checkbox" id="saleFee" value="1" v-model="checkedSaleFeeStatus" @change="someHandlerChange()">
                                    <label for="saleFee">あり</label>
                                </div>
                            </div>
                            <div class="page-separator-line"></div>
                            <div class="row">
        ...
        <!-- <div class="bodyButtonLeft" v-if='isMobile == false'>
            <a type="button" class="btn btn-outline-secondary2" style="background:green" :href="'/admin/partner-sale-pdf?' + conditionSearch">
                <i class="fa fa-plus-square"><div class="labelButton">報酬出金票(PDF)</div></i>
            </a>        
        </div> -->
        <div class="bodyButtonTop">
            <a type="button" class="btn btn-outline-secondary3" style="background:green" :href="'/admin/partner-sale-pdf?' + conditionSearch">
                <i class="fas fa-file-pdf"><span class="labelButton">報酬出金票(PDF)</span></i>
            </a> 
            ...
            <div class="row page_container_custom_marginright">
                <div :class="''+classColLG12">
                    <div :class="'' + classBodayRightContentGrid">
                        ...
                        <h5 class="threadLabelCenter">報酬合計：(( new Intl.NumberFormat('ja-JP', { style: 'currency', currency: 'JPY' }).format(sumHoaHong) ))</h5>
                                ...
                                <table id="gridTable" class="table thead-border-top-0 table-nowrap">
                                    <thead class="thead-light">
                                        <tr>
                                            ...
                                            <th scope="col" v-if='type_show == 1'>
                                                <div class="threadLabelCenter">振込日</div>
                                            </th>
                                            <th scope="col" v-if='type_show == 1'>
                                            <div>振込先</div>
                                            </th>
                                            <th scope="col" v-if='type_show == 1'>
                                                <div class="threadLabelCenter">報酬額</div>
                                            </th>
                                            <th scope="col" v-if='type_show == 1'>
                                                <div class="threadLabelCenter">振込手数料</div>
                                            </th>
                                            <th scope="col" v-if='type_show == 1'>
                                                <div class="threadLabelCenter">振込状態</div>
                                            </th>
                                        ...
                                        <tr v-for="item in list">
                                            <td v-if='type_show == 2' class="p-0 pl-2 pb-2 fullWidth">
                                                <p class="rowContent">
                                                    <table class="m-0 table thead-border-top-0 table-nowrap table-mobile">
                                                        ...
                                                        <tr>
                                                            <td class="titleTd">振込先：</td>
                                                            <td>
                                                                <p class="mb-0" v-for="itemCTV in item.ctv_sales_list" >
                                                                    <span v-if="itemCTV.payplace == 1">
                                                                        <span v-if=" itemCTV.ten_bank ">((itemCTV.ten_bank)) <br></span>
                                                                        <span v-if=" itemCTV.chinhanh ">((itemCTV.chinhanh)) <br> </span>
                                                                        <span v-if=" itemCTV.stk ">((itemCTV.stk)) <br></span>
                                                                        <span v-if=" itemCTV.ten_chutaikhoan ">(( parseName(itemCTV.ten_chutaikhoan) )) <br></span>
                                                                    </span>
                                                                    <span v-if="itemCTV.payplace == 2">
                                                                        <span style="text-align:center">現金</span>
                                                                        <a type="button" class="btn btn-outline-secondary3" style="background:#e22e5d"  :href="'/admin/partner-sale-receipt-pdf/' + item.id">
                                            ...
                                            <td v-if='type_show == 1'>
                                                <p class="mb-0" v-for="itemCTV in item.ctv_sales_list" >
                                                    ...
                                                    <span v-if="itemCTV.payplace == 2" style="text-align:center">
                                                        <span >現金</span><br>
                                                        <a type="button" class="btn btn-outline-secondary3" style="background:#e22e5d"  :href="'/admin/partner-sale-receipt-pdf/' + item.id">
                                                            <i class="fas fa-file-pdf"><span class="labelButton">出金伝票(PDF)</span></i>
                                                        </a>
