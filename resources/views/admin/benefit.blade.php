    ...
    <div class=" mb-sm-0 mr-sm-24pt" style="margin:10px;" >
        <h1 class="h3 mb-0">
            <div class="row mb-32pt">
                <div class="col-lg-2">
                    <div @click="showLeftBar()" style="text-decoration: underline"></div>
                </div>
                <div class="col-lg-9">
                <center>
                    <div><label class="form-label m-10">表示件数： ((sumCount)) 件</label><div>
                    <div style="margin-top:-10px"><label class="form-label">利益合計：<label style="color:red">(( new Intl.NumberFormat('ja-JP', { style: 'currency', currency: 'JPY' }).format(sumPay) ))</label></label>
                    </div>
                    </center>
                                ...
                                <table class="table mb-0 thead-border-top-0 table-nowrap">
									<thead class="thead-light">
										<tr>
											...
											<th scope="col" style="text-align:center">売上</th>
											<th scope="col" style="text-align:center">支給</th>
											<th scope="col" style="text-align:right">利益</th>
                                            ...
                                            <td style="text-align:right">
                                                <div class="d-flex flex-column">
													<table cellspacing="0" cellpadding="0" style="border:0;;table-layout: fixed;width:100px;">
														<tr style="border:0;">
														<td style="border:0;padding: 2px;text-transform: uppercase;">
                                                        (( new Intl.NumberFormat('ja-JP', { style: 'currency', currency: 'JPY' }).format(item.benefit) ))
                                                        </td></tr>
													</table>
                                                </div>
                                            </td>
...
new Vue({
    ...
    methods: {
        ...
        onLoadPagination() {
            ...
            $.ajax({
                type: 'GET',
                url: "{{route('admin.getListBenefit')}}?page=" + this.page  + conditionSearch ,
