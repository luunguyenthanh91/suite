        ...
        <div
            ...
            <div class="flex d-flex flex-column flex-sm-row align-items-center mb-24pt mb-md-0">
                ...
                <div class="mb-24pt mb-sm-0 mr-sm-24pt">
                    <h1 class="h2 mb-0">Update Template Mail</h1>

                    <ol class="breadcrumb m-0 p-0">
                        <li class="breadcrumb-item"><a href="/admin">Home</a></li>
                        <li class="breadcrumb-item"><a href="/admin/mails">Template Mail</a></li>
                        <li class="breadcrumb-item active">Edit Template Mail</li>
                    </ol>
                    ...
                    <div class="flex" style="max-width: 100%">
                        <form action="" method="POST" class="p-0 mx-auto">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="name" class="form-control" id="tenNganHang" value="{{$data->name}}">
                            </div>
                            <div class="form-group">
                                <label class="form-label" for="tenNganHang">From:</label>
                                <input type="text" name="from_mail" class="form-control" id="tenNganHang" value="{{$data->from_mail}}">
                            </div>
                            <div class="form-group">
                                <label class="form-label" for="chiNhanhNganHang">To:</label>
                                <input type="text" name="to_mail" class="form-control" id="chiNhanhNganHang" value="{{$data->to_mail}}">
                            </div>
                            <div class="form-group">
                                <label class="form-label" for="tenNganHang">CC:</label>
                                <input type="text" name="cc_mail" class="form-control" id="tenNganHang" value="{{$data->cc_mail}}">
                            </div>
                            <div class="form-group">
                                <label class="form-label" for="tenNganHang">Subject:</label>
                                <input type="text" name="subject" class="form-control" id="tenNganHang" value="{{$data->subject}}">
                            </div>
                            <div class="form-group">
                                <label class="form-label" for="soTaiKhoan">Body:</label>
                                <textarea type="text" name="body" class="form-control" rows="10" >{{@$data->body}}</textarea>
                            </div>
                            <div class="form-group">
