...
<div class="mdk-drawer-layout__content page-content">
    ...
    <div id="list-data">
        ...
        <div class="bodyButtonTop">
            ...
            <a type="button" class="btn btn-outline-secondary3" style="background:red" href="/admin/expensesview/{{$id}}">
                    ...
                    <div class="col-lg-3">
                        <div class="form-group">
                            ...
                            <select class="form-control custom-select" name="typeLog">
                                <option value="" ></option>
                                <option value="1" @if(@$data['typeLog'] == 1) selected @endif>租税公課</option>
                                <option value="2" @if(@$data['typeLog'] == 2) selected @endif>修繕費</option>
                                <option value="3" @if(@$data['typeLog'] == 3) selected @endif>水道光熱費</option>
                                <option value="4" @if(@$data['typeLog'] == 4) selected @endif>保険料</option>
                                <option value="5" @if(@$data['typeLog'] == 5) selected @endif>消耗品費</option>
                                <option value="6" @if(@$data['typeLog'] == 6) selected @endif>法定福利費</option>
                                <option value="7" @if(@$data['typeLog'] == 7) selected @endif>給料賃金</option>
                                <option value="8" @if(@$data['typeLog'] == 8) selected @endif>地代家賃</option>
                                <option value="9" @if(@$data['typeLog'] == 9) selected @endif>外注工賃</option>
                                <option value="10" @if(@$data['typeLog'] == 10) selected @endif>支払手数料</option>
                                <option value="11" @if(@$data['typeLog'] == 11) selected @endif>旅費交通費</option>
                                <option value="12" @if(@$data['typeLog'] == 12) selected @endif>開業費/創立費</option>
                                <option value="13" @if(@$data['typeLog'] == 13) selected @endif>通信費</option>
                                <option value="14" @if(@$data['typeLog'] == 14) selected @endif>接待交際費</option>
                                <option value="15" @if(@$data['typeLog'] == 15) selected @endif>その他</option>
                            </select>
                        </div>
                    </div>
                    <div class="col-lg-3">
                        ...
                        <div class="form-group">
                            ...
                            <li id="images">   
                                <div class="search-form" >
                                    ...
                                    @if (@$data['file']) 
                                        <a href="{{@$data['file']}}"><i class="fas fa-download"><span class="labelButton"></span></i></a>
                                    @endif
                                </div>
                                <div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="form-group">
                            ...
                            <textarea type="text" name="note" class="form-control textarea ckeditor col-lg-12" rows="10">{{@$data['note']}}</textarea>
                        </div>
                    </div>
                </div>
            </form>
