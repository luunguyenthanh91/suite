...
<div class="mdk-drawer-layout__content page-content page-notscrool">
    ...
    <div id="list-data" style="background:white !important;">
        <div class="modal fade" id="create">
            <form method="POST" class="modal-dialog char-w-new" action="/admin/new-costtransport">
                @csrf
                                    ...
                                    <div class="bodyContentRight tableFixHead wrapper">
                                        ...
                                        <div class="card-footer p-8pt">
                                            <ul class="pagination justify-content-start pagination-xsm m-0">
                                                ...
                                                <li class="page-item" @click="onNextPage()" v-bind:class="page > count - 1 ? 'disabled' : ''">
                                                    <a class="page-link" href="#">
    ...
    new Vue({
        ...
        methods: {
            ...
            onLoadPagination() {
                ...
                $.ajax({
                    type: 'GET',
                    url: "{{route('admin.getListCostTransport')}}?page=" + this.page + conditionSearch,
