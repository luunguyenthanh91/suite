    ...
    <div id="list-data">
        ...
        <div class="splitter" >
            ...
            <div class="bodyButtonTop">
                    <a type="button" class="btn btn-outline-secondary3 newButtonBg" data-toggle="modal" data-target="#createBookname">
                                            ...
                                            <thead class="thead-light">
                                                <tr>
                                                    ...
                                                    <th scope="col" @click="sort('employee_depname')">
                                                        <div v-bind:class="[sortBy === 'employee_depname' ? sortDirection : '']">{{ trans('label.dep2') }}</div>
                                                    </th>
                                                    <th scope="col"  @click="sort('inside_history')">
                                                        <div v-bind:class="[sortBy === 'inside_history' ? sortDirection : '']">{{ trans('label.inside_history') }}</div>
                                                    </th>
                                                    <th scope="col"  @click="sort('retire_date')">
                                                        <div v-bind:class="[sortBy === 'retire_date' ? sortDirection : '']">{{ trans('label.retire_date') }}</div>
                                                    </th>
...
new Vue({
    ...
    methods: {  
        ...
        onLoadPagination() {
            ...
            $.ajax({
                type: 'GET',
                url: "{{route('admin.getListBookname')}}?page=" + this.page  + conditionSearch ,
