...
<div class="main-content-inner" id="list-data">
    ...
    <div class="page-content">
        <div class="breadcrumbs breadcrumbs-fixed" id="breadcrumbs">
            <h3>
                <span class="hidden-320 ng-binding">Phép</span>
            </h3>
                ...
                <div class="modal-container" v-if="addModal == 2">
                    <div class="container-popup  col-xs-4">
                        ...
                        <div class="form-horizontal col-xs-12 mt-10">
                            ...
                            <div class="form-group">
                                <label class="col-sm-2 control-label no-padding-right" > Tên Phép </label>
                                <div class="col-sm-10">
...
new Vue({
    ...
    methods: {
        ...
        onLoadPagination() {
            ...
            $.ajax({
                type: 'GET',
                url: "{{route('admin.getPhep')}}?page=" + this.page + "&name=" + this.conditionName,
                success: function(data){
                    if (data.count > 0) {
                        data.data.map(item => {
                            item.edit = 1;
