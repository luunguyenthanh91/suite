...
<div class="mdk-drawer-layout__content page-content page-notscrool">
    ...
    <div id="list-data">
                        ...
                        <div class="table-responsive">
                            <div class="row standardColorSearch">
                                <div class="form-group col-lg-12">
                                    <label class="form-label">受注月</label>
                            ...
                            <div class="row">
                                <div class="form-group col-lg-12">
                                    <input type="checkbox" value="0" id="akaji" v-model="checkAkaji" @change="someHandlerChange()">
                                    <label for="akaji" class="statusMinus">赤字</label>
                                </div>
                            </div>
                            <div class="row">
                                <div class="form-group col-lg-12">
        ...
        <!-- <div class="bodyButtonLeft" v-if='isMobile == false'>
            <a type="button" class="btn btn-outline-secondary2" style="background:green" href="/admin/projectnew">
                <i class="fa fa-plus-square"><div class="labelButton">新規登録</div></i>
            </a>
            <a type="button" class="btn btn-outline-secondary2" style="background:#673FF7" href="/admin/calendar">
                <i class="fas fa-calendar-alt"><div class="labelButton">予定表</div></i>
            </a>               
        </div> -->
        <div class="bodyButtonTop">
            <a type="button" class="btn btn-outline-secondary3" style="background:green" href="/admin/projectnew">
                <i class="fa fa-plus-square"><span class="labelButton">新規登録</span></i>
            </a>
            <a type="button" class="btn btn-outline-secondary3" style="background:#673FF7" href="/admin/calendar">
                <i class="fas fa-calendar-alt"><span class="labelButton">予定表</span></i>
            </a>   
                            ...
                            <table id="gridTable" class="table thead-border-top-0 table-nowrap">
                                        <thead class="thead-light">
                                            <tr>
                                                ...
                                                <th scope="col" v-if='type_show == 1'>
                                                    <div class="threadLabelCenter">契約金</div>
                                                </th>
                                                <th scope="col" v-if='type_show == 1'>
                                                    <div class="threadLabelCenter">売上予測</div>
                                                </th>
                                                <th scope="col" v-if='type_show == 1'>
                                                    <div class="threadLabelCenter">利益予測</div>
                                                </th>
                                                <th scope="col" v-if='type_show == 1'>
                                                    <div class="threadLabelCenter">営業報酬</div>
                                                </th>
                                                <th scope="col" v-if='type_show == 1'>
                                                    <div class="threadLabelCenter">通訳給与</div>
                                                </th>
                                                <th scope="col" v-if='type_show == 1'>
                                                    <div class="threadLabelCenter">源泉所得税</div>
                                                </th>
                                                <th scope="col" v-if='type_show == 1'>
                                                    <div class="threadLabelCenter">交通費</div>
                                                </th>
                                                <th scope="col" v-if='type_show == 1'>
                                                    <div class="threadLabelCenter">振込手数料</div>
                                                </th>
                                        ...
                                        <tbody class="list" id="search">
                                            <tr v-for="item in list">
                                                <td v-if='type_show == 2' :class="item.classStyle + ' p-0 pl-2 pb-2 fullWidth'">
                                                    <p class="rowContent">
                                                        <table class="m-0 table thead-border-top-0 table-nowrap table-mobile">
                                                            <tr>
                                                                <td :class="item.classStyle +' titleTd'">受注番号：</td>
                                                                <td>
                                                                    <p class="rowContent">
                                                                        <span :class="item.classStyle"> ((item.codejob)) </span><br>
                                                                        ...
                                                                        <a type="button" class="btn btn-outline-secondary3" style="background:blue" :href="'/admin/company/pdf-type-new/' + item.id">
                                                            ...
                                                            <tr>
                                                                <td :class="item.classStyle +' titleTd'">ステータス：</td>
                                                                <td>
                                                                    <p :class="'rowContent ' + item.classStyle">
                                                            ...
                                                            <tr>
                                                                <td  :class="item.classStyle +' titleTd'">通訳日：</td>
                                                                <td>
                                                                    <p :class="'rowContent ' + item.classStyle">
                                                                        ((item.ngay_pd))
                                                                        <br>
                                                                        ((item.address_pd))
                                                                        <a target="_blank" :href="'https://www.google.co.jp/maps/place/'+item.address_pd" :class="item.classStyle">
                                                            ...
                                                            <tr>
                                                                <td  :class="item.classStyle +' titleTd'">営業者：</td>
                                                                <td>
                                                                    <span v-for="itemCTV in item.ctv_sales_list" >
                                                                        <p class="rowContent">
                                                                            <span :class="item.classStyle">(( parseName(itemCTV.name) ))</span><br>
                                                                            <span :class="item.classStyle">(( parseAddr(itemCTV.address) ))</span><br>
                                                                            <span :class="item.classStyle">(( parsePhone(itemCTV.phone) ))</span><br>
                                                            ...
                                                            <tr>
                                                                <td :class="item.classStyle +' titleTd'">通訳者：</td>
                                                                <td>
                                                                    <span v-for="itemCTV in item.ctv_list">
                                                                        <p class="rowContent">
                                                                            <span :class="item.classStyle">(( parseName(itemCTV.name) ))</span>
                                                                            <i v-if="itemCTV.male == 1" class="fa fa-male"></i>
                                                                            <i v-if="itemCTV.male == 2" class="fa fa-female"></i>
                                                                            <br>
                                                                            <span :class="item.classStyle">(( parseAddr(itemCTV.address) )) </span>
                                                                            <a target="_blank" :href="'https://www.google.co.jp/maps/place/'+itemCTV.address" :class="item.classStyle">
                                                                                <i class="fas fa-map-marked-alt"></i>
                                                                            </a>
                                                                            <br>
                                                                            <span :class="item.classStyle">(( parsePhone(itemCTV.phone) )) </span>
                                                                            <a :href="'tel:'+itemCTV.phone" :class="item.classStyle">
                                                            ...
                                                            <tr>
                                                                <td :class="item.classStyle +' titleTd'">売上予測：</td>
                                                                <td :class="item.classStyle">
                                                                    (( new Intl.NumberFormat('ja-JP', { style: 'currency', currency: 'JPY' }).format(item.tong_thu_du_kien) ))
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td :class="item.classStyle +' titleTd'">利益予測：</td>
                                                                <td :class="item.classStyle">
                                                                    (( new Intl.NumberFormat('ja-JP', { style: 'currency', currency: 'JPY' }).format(item.tong_kimduocdukien) ))
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    </div>
                                                </td>
                                                <td :class="item.classStyle" v-if='type_show == 1'>
                                                    <p class="rowContent">
                                                        <span :class="item.classStyle"> ((item.codejob)) </span><br>
                                                        <a type="button" class="btn btn-outline-secondary2"  style="background:#F36C1F" target="_blank" :href="'/admin/projectview/' + item.id">
                                                            <i class="fas fa-info-circle"></i>
                                                ...
                                                <td :class="item.classStyle+' moneyCol'" v-if='type_show == 1'>
                                                    (( new Intl.NumberFormat('ja-JP', { style: 'currency', currency: 'JPY' }).format(item.tienphiendich) ))
                                                </td>
                                                <td :class="item.classStyle+' moneyCol'" v-if='type_show == 1'>
                                                    (( new Intl.NumberFormat('ja-JP', { style: 'currency', currency: 'JPY' }).format(item.tong_thu_du_kien) ))
                                                </td>
                                                ...
                                                <td :class="item.classStyle+' moneyCol'" v-if='type_show == 1'>
                                                    <p v-for="itemCTV in item.ctv_sales_list" >
                                                ...
                                                <td :class="item.classStyle" v-if='type_show == 1'></td>
                                            </tr>
                                        </tbody>
                                    </table>                       
