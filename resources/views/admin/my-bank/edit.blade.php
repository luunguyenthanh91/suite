        ...
        <div
            ...
            <div class="flex d-flex flex-column flex-sm-row align-items-center mb-24pt mb-md-0">
                ...
                <div class="mb-24pt mb-sm-0 mr-sm-24pt">
                    <h1 class="h2 mb-0">Update My Bank Account</h1>
                    ...
                    <div class="flex" style="max-width: 100%">
                        <form action="" method="POST" class="p-0 mx-auto">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="name_bank" class="form-control" id="tenNganHang"  value="{{$data->name_bank}}">
                            </div>
                            <div class="form-group">
                                <label class="form-label" for="tenNganHang">Mã Số Ngân Hàng:</label>
                                <input type="text" name="ms_nganhang" class="form-control" id="tenNganHang"  value="{{$data->ms_nganhang}}">
                            </div>
                            <div class="form-group">
                                <label class="form-label" for="chiNhanhNganHang">Chi Nhánh Ngân Hàng:</label>
                                <input type="text" name="chi_nhanh" class="form-control" id="chiNhanhNganHang"  value="{{$data->chi_nhanh}}">
                            </div>
                            <div class="form-group">
                                <label class="form-label" for="tenNganHang">Mã Số Chi Nhánh Ngân Hàng:</label>
                                <input type="text" name="ms_chinhanh" class="form-control" id="tenNganHang"  value="{{$data->ms_chinhanh}}">
                            </div>
                            <div class="form-group">
                                <label class="form-label" for="tenNganHang">Loại Tài Khoản:</label>
                                <input type="text" name="type" class="form-control" id="tenNganHang"  value="{{$data->type}}">
                            </div>
                            <div class="form-group">
                                <label class="form-label" for="soTaiKhoan">Số Tài Khoản:</label>
                                <input type="text" name="stk" class="form-control" id="soTaiKhoan"  value="{{$data->stk}}">
                            </div>
                            <div class="form-group">
                                <label class="form-label" for="chuTaiKhoan">Tên Chủ Tài Khoản:</label>
                                <input type="text" name="ten_chusohuu" class="form-control" id="chuTaiKhoan"  value="{{$data->ten_chusohuu}}" >
                            </div>
