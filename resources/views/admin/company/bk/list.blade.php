    ...
    <div class=" mb-sm-0 mr-sm-24pt" style="margin:10px;" >
        <h1 class="h3 mb-0">
            <div class="row mb-32pt">
                <div class="col-lg-2">
                    <div @click="showLeftBar()" style="text-decoration: underline">受注リスト</div>
                </div>
                <div class="col-lg-9">
                <center>
                    <div><label class="form-label m-10">表示件数： ((list.length)) of  ((sumCount)) 件</label><div>
                    </center>
                </div>
                <div class="col-lg-1">
                    <div style="text-align:right; margin:10px"><a href="/admin/company/add" class="btn btn-primary">新規登録</a></div>
                </div>
            </div>
        </h1>
    </div>
                                                ...
                                                <div class="d-flex flex-column">
													<table cellspacing="0" cellpadding="0" style="border:0;">
														...
														<td style="border:0;padding: 2px;">
															 <a target="_blank" :href="'/admin/company/edit/' + item.id" class="js-lists-values-employee-name">
