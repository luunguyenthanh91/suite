...
<div class="mdk-drawer-layout__content page-content">
    ...
    <div id="list-data">
        <div
            ...
            <div class="row ml-2" role="tablist" v-if="edit_form == 1">
                <div class="col-auto">
                    <a @click="onSubmit()" class="btn btn-primary btn-submit">保存</a>
                    <a @click="cancleEdit()"  class="btn btn-danger">キャンセル</a>
                </div>
            </div>
