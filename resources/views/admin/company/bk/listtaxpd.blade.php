...
<div class="mdk-drawer-layout__content page-content page-notscrool3">
    ...
    <div id="list-data">
        ...
        <div class="bodyButtonLeft" v-if='isMobile == false'>
            <a type="button" class="btn btn-outline-secondary2" style="background:green" :href="'/admin/company/pdf-taxpd?' + conditionSearch">
                <i class="fa fa-plus-square"><div class="labelButton">出力</div></i>
            </a>        
        </div>
        <div class="bodyButtonTop" v-if='isMobile == true'>
            <a type="button" class="btn btn-outline-secondary3" style="background:green" :href="'/admin/company/pdf-taxpd?' + conditionSearch">
                <i class="fas fa-file-pdf">出力</i>
            </a> 
