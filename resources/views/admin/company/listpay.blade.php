    ...
    <div class=" mb-sm-0 mr-sm-24pt" style="margin:10px;">
        <h1 class="h3 mb-0">
            <div class="row mb-32pt">
                <div class="col-lg-2">
                    <div @click="showLeftBar()" style="text-decoration: underline">入金リスト</div>
                    <div class="form-label m-10">(通訳事業)</div>
                </div>
                <div class="col-lg-7">
                <center>
                    <div><label class="form-label m-10">表示件数： ((list.length)) 件</label><div>
                    <div style="margin-top:-10px"><label class="form-label">入金額合計：<label style="color:red">(( new Intl.NumberFormat('ja-JP', { style: 'currency', currency: 'JPY' }).format(sumPay) ))</label></label>
                    </div>
                    </center>
                </div>
                <div class="col-lg-3">
                    <div style="text-align:right; margin:10px">
                    <a target="_blank" :href="'/admin/company/pdf-pay?' + conditionSearch"
                      class="btn btn-warning">出力</a>
                    <a target="_blank" href="/admin/chart-report-price/news" class="btn btn-success">グラフ</a></div>
                </div>
            </div>
        </h1>
    </div>
        ...
        <div class="container page__container page-section" style="margin-top:-40px">
            ...
            <div class="col-lg-2">
					...
					<div class="form-group col-lg-12">
                        <label class="form-label m-0">入金月</label>
...
<div class="form-group col-lg-12">
    <label class="form-label m-0">入金確認</label>
                                ...
                                <table class="table mb-0 thead-border-top-0 table-nowrap">
									<thead class="thead-light">
										<tr>
											...
											<th scope="col">
                                                <center @click="sortPayDate()" style="text-decoration: underline">入金日</center>
                                            </th>
                                            <th scope="col" style="text-align:center">受領額</th>
                                            <th scope="col" style="text-align:center">入金確認済み</th>
                                        ...
                                        <tr v-for="item in list">
                                            ...
                                            <td >
                                                <div class="d-flex flex-column">
													<table cellspacing="0" cellpadding="0" style="border:0;;table-layout: fixed;width:100px;">
														<tr style="border:0;">
														<td style="white-space: normal;border:0;padding: 2px;">((item.date_company_pay))</td>
														</tr>
													</table>
                                                </div>
                                            </td>
                                            ...
                                            <div class="d-flex flex-column">
                                                     <table cellspacing="0" cellpadding="0" style="border:0;">
														<tr style="border:0;">
                                                        <td style="border:0;padding: 2px;">
														<p class="mb-0" v-if='item.tong_thu > 0'>(( new Intl.NumberFormat('ja-JP', { style: 'currency', currency: 'JPY' }).format(item.tong_thu) ))</p>
														</tr>
													</table>
                                                </div>
                                            </td>
...
new Vue({
    ...
    methods: {
        ...
        sortPayDate: function() {
            this.sortName = "company.date_company_pay";
            this.onLoadPagination();
        },
        sortJobID: function() {
        ...
        onLoadPagination() {
            ...
            $.ajax({
                type: 'GET',
                url: "{{route('admin.getAllCompanyPay')}}?page=" + this.page  + conditionSearch ,
