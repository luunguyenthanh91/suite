...
<div class="mdk-drawer-layout__content page-content">
    ...
    <div class=" mb-sm-0 mr-sm-24pt" style="margin:10px;" >
        <h1 class="h3 mb-0">
            <div class="row mb-32pt">
                <div class="col-lg-9">
                <center>
                    <div><label class="form-label m-10">表示件数： ((sumCount)) 件</label><div>
                    <div style="margin-top:-10px"><label class="form-label">支給合計：<label style="color:red">(( new Intl.NumberFormat('ja-JP', { style: 'currency', currency: 'JPY' }).format(sumPay) ))</label></label>
                    </div>
                    </center>
                ...
                <div class="col-lg-1">
                    <div style="text-align:right; margin:10px">
                        <a target="_blank" :href="'/admin/move-fee-pdf?' + conditionSearch"
                        class="btn btn-warning">出力</a></div>
         ...
         <div
            ...
            <div class="flex d-flex flex-column flex-sm-row align-items-center mb-24pt mb-md-0">
                ...
                <div class="mb-24pt mb-sm-0 mr-sm-24pt">
                    <h1 class="h2 mb-0">
                        <a  @click="showLeftBar()" style="text-decoration: underline">通訳案件リスト</a>
                    </h1>
                </div>
            </div>
            ...
            <div class="row　 ml-2" role="tablist">
                <div class="col-auto">
                    <a href="/admin/company/add" class="btn btn-primary col-lg-12">新規登録</a>
                </div>
            </div>
 ...
 -->
            ...
            <div class="col-lg-2">
                    ...
                    <div class="form-group col-lg-12">
                        ...
                        <input type="date" class="form-control search" @change="someHandlerChange()"
                                v-on:keyup.enter="someHandlerChange()" v-model="ngay_phien_dich" min="2021-03-17">
                    </div>
  ...
  color: #069;
  text-decoration: underline;
  cursor: pointer; margin-left:20px;">全てON</button>
					...
					<div class="form-group col-lg-12">
                        <label class="form-label m-0">種類</label><br>
                ...
                <div class="col-lg-10 d-flex ">
                    ...
                    <div class="flex" style="max-width: 100%">
                     <!-- <div class="col-lg-12" style="text-align:right;">
                            <label class="form-label m-10">表示件数： ((list.length)) 件</label> 
                        </div> -->
                        <div class="card m-0">
                                ...
                                <table class="table mb-0 thead-border-top-0 table-nowrap">
									<thead class="thead-light">
										<tr>
											...
											<th scope="col" style="text-align:right">交通費</th>
											<th scope="col" style="text-align:right">振込手数料</th>
											<th scope="col" style="text-align:right">通訳所得源泉徴収</th>
											<th scope="col" style="text-align:right">支給合計</th>
                                        ...
                                        <tr v-for="item in list">
                                                ...
                                                <div class="d-flex flex-column">
													<table cellspacing="0" cellpadding="0" style="border:0;">
                                                        ...
                                                        <span class="mb-0" v-for="itemCTV in item.ctv_sales_list" >
                                                            <a  target="_blank" :href="'/admin/ctvjobs/edit/' + itemCTV.ctv_jobs_id" >
                                                            ((itemCTV.name))
                                                            </a>
                                                            <div>((itemCTV.address))</div>
                                                            <div>((itemCTV.phone))</div>
														</span>
                                                        </td>
														</tr>
													</table>
                                            ...
                                            <td style="text-align:right">
                                                <div class="d-flex flex-column">
													<table cellspacing="0" cellpadding="0" style="border:0;;table-layout: fixed;width:100px;">
														<tr style="border:0;">
														<td style="border:0;padding: 2px;align:right">
                                                        (( new Intl.NumberFormat('ja-JP', { style: 'currency', currency: 'JPY' }).format(item.sumSale) ))
                                                        </td>
														</tr>
													</table>
                                                </div>
                                            ...
                                            <td style="text-align:right">
                                                <div class="d-flex flex-column">
													<table cellspacing="0" cellpadding="0" style="border:0;;table-layout: fixed;width:100px;">
														<tr style="border:0;">
														<td style="border:0;padding: 2px;text-transform: uppercase;">
                                                        (( new Intl.NumberFormat('ja-JP', { style: 'currency', currency: 'JPY' }).format(item.sumBankFee) ))
                                                        </td>
                                                        </tr>
													</table>
                                                </div>
                                            ...
                                            <td style="text-align:right">
                                                <div class="d-flex flex-column">
													<table cellspacing="0" cellpadding="0" style="border:0;;table-layout: fixed;width:100px;">
														<tr style="border:0;">
														<td style="border:0;padding: 2px;text-transform: uppercase;">
                                                        (( new Intl.NumberFormat('ja-JP', { style: 'currency', currency: 'JPY' }).format(item.cost) ))
                                                        </td></tr>
													</table>
                                                </div>
                                            </td>
...
new Vue({
    ...
    methods: {
        ...
        onLoadPagination() {
            ...
            $.ajax({
                type: 'GET',
                url: "{{route('admin.getListCost')}}?page=" + this.page  + conditionSearch ,
