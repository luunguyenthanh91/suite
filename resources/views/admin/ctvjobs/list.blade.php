        ...
        <div
            ...
            <div class="flex d-flex flex-column flex-sm-row align-items-center mb-24pt mb-md-0">
                ...
                <div class="mb-24pt mb-sm-0 mr-sm-24pt">
                    <h1 class="h2 mb-0">営業者一覧</h1>

                    <ol class="breadcrumb m-0 p-0">
                        <li class="breadcrumb-item"><a href="/admin">ホーム</a></li>
                        <li class="breadcrumb-item active">営業者</li>
                    </ol>
            ...
            <div class="row" role="tablist">
                <div class="col-auto">
                    <a href="/admin/ctvjobs/add" class="btn btn-outline-secondary">新規登録</a>
                </div>
            </div>
                                            ...
                                            <td>
                                                <div class="d-flex flex-column">
                                                    <div style="display: flex; justify-content: flex-start; align-items: center;">
                                                        <a  style="display: flex; justify-content: center; align-items: center; float: left;" :href="'/admin/ctvjobs/edit/' + item.id" >
                                                    ...
                                                    <p class="mb-2 "><a :href="'mailto:'+item.email"><span class="material-icons sidebar-menu-icon sidebar-menu-icon--left icon-image-preview">email</span>((item.email_cut))</a></p>
    ...
    methods: {
        ...
        deleteRecore(_i) {
            ...
            Swal.fire({
                ...
                that.loadingTable = 1;
                $.ajax({
                    url: "/admin/ctvjobs/delete/" + _i.id,
                    type: 'GET',
                    dataType: 'json',
