                                            ...
                                            <table id="gridTable" class="table thead-border-top-0 table-nowrap mb-0">
                                                <thead class="thead-light">
                                                    <tr>
                                                        ...
                                                        <th @click="sort('type')" class="textAlignCenter">
                                                            <div v-bind:class="[sortBy === 'type' ? sortDirection : '']">{{ trans('label.cost_transport_type') }}</div>
                                                        </th>
                                                        <th click="sort('place_from')" class="textAlignCenter">
                                                            <div v-bind:class="[sortBy === 'place_from' ? sortDirection : '']">{{ trans('label.cost_transport_place') }}</div>
                                                        </th>
                                                        <th @click="sort('name')" class="textAlignCenter">
                                                            <div v-bind:class="[sortBy === 'name' ? sortDirection : '']">{{ trans('label.cost_transport_name') }}</div>
                                                        </th>
                                                    ...
                                                    <tr v-bind:class="[item.action == 'delete' ? 'hidden' : '']" v-for="(item,key) in sortedProducts">
                                                        ...
                                                        <td class="textAlignCenter">
                                                            <div class="search-form" >
                                                                <select class="form-control custom-select" :name="'transport['+key+'][type]'" style="width:100px !important">
                                                                    <option value="" ></option>
                                                                    <option value="1" v-if="item.type == 1" selected>{{ trans('label.type_transport1') }}</option>
                                                                    <option value="1" v-if="item.type != 1">{{ trans('label.type_transport1') }}</option>
                                                                    <option value="2" v-if="item.type == 2" selected>{{ trans('label.type_transport2') }}</option>
                                                                    <option value="2" v-if="item.type != 2">{{ trans('label.type_transport2') }}</option>
                                                                    <option value="3" v-if="item.type == 3" selected>{{ trans('label.type_transport3') }}</option>
                                                                    <option value="3" v-if="item.type != 3">{{ trans('label.type_transport3') }}</option>
                                                                    <option value="4" v-if="item.type == 4" selected>{{ trans('label.type_transport4') }}</option>
                                                                    <option value="4" v-if="item.type != 4">{{ trans('label.type_transport4') }}</option>
                                                                </select>
                                                            </div>
                                                        </td>
                                                        <td class="textAlignCenter">
                                                            <div class="d-flex ">
                                                                <input style="min-width:150px;"　class="form-control" type="text" v-model="item.place_from" :name="'transport['+key+'][place_from]'" />　<label style="margin:10px;">～</label>　<input　class="form-control"  style="min-width:150px;" type="text" v-model="item.place_to" :name="'transport['+key+'][place_to]'" />
                                                            </div>
                                                        </td>
                                                        <td>
