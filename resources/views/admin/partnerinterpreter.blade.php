...
<div class="mdk-drawer-layout__content page-content page-notscrool3">
    ...
    <div id="list-data">
        ...
        <div class="bodyButtonTop">
            <a type="button" class="btn btn-outline-secondary3" style="background:green" :href="'/admin/partner-interpreter-pdf?' + conditionSearch">
                <i class="fas fa-file-pdf"><span class="labelButton">給与管理表(PDF)</span></i>
            </a> 
            ...
            <div class="row page_container_custom_marginright">
                <div :class="''+classColLG12">
                    <div :class="'' + classBodayRightContentGrid">
                        ...
                        <h5 class="threadLabelCenter">給与支給合計：(( new Intl.NumberFormat('ja-JP', { style: 'currency', currency: 'JPY' }).format(sumPriceTotal) ))</h5>
                            ...
                            <table id="gridTable" class="table thead-border-top-0 table-nowrap">
                                        <thead class="thead-light">
                                            <tr>
                                                ...
                                                <th scope="col" v-if='type_show == 1'>
                                                <div class="threadLabelCenter">振込先</div>
                                                </th>
                                                <th scope="col" v-if='type_show == 1'>
                                            ...
                                            <tr v-for="item in list">
                                                    ...
                                                    <p class="rowContent">
                                                        <table class="m-0 table thead-border-top-0 table-nowrap table-mobile">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <p v-for="itemCTV in item.ctv_list" >
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <p  v-for="itemCTV in item.ctv_list" >
                                                                        <span v-if="itemCTV.bank_id != 2 && itemCTV.bank_id != ''">
                                                ...
                                                <td v-if='type_show == 1' style="text-align:center">
                                                    <p  v-for="itemCTV in item.ctv_list" >
                                                        ...
                                                        <span v-if="itemCTV.bank_id == 2">
                                                            <span>現金</span><br>
                                                            <a type="button" class="btn btn-outline-secondary3" style="background:#e22e5d"  :href="'/admin/partner-interpreter-receipt-pdf/' + item.id">
                                                                <i class="fas fa-file-pdf"><span class="labelButton">出金伝票(PDF)</span></i>
                                                            </a>
                                                        </span>
                                                    </p>
